INSERT INTO utilisateur (id, civilite, nom, prenom, telephone, mail, login, mot_de_passe, est_membre, adresse_id)
VALUES (1,'M','DUPONT','Martin','0324593874','martin.dupont@gmail.com','dupont','$2a$10$TpRLNPP8Q1XJqONRvS4QI.ea2f5.jsB/.U4ZnL3iSyFiGZ6pBPHfe',0,1);
INSERT INTO utilisateur (id, civilite, nom, prenom, telephone, mail, login, mot_de_passe, est_membre, adresse_id)
VALUES (2,'M','TINTIN','Paul','0654654874','paul.depres@hotmail.com','tintin','$2a$10$b/DpB2NSMWMokB.ZOP/D4ehRFqXRSx3fKib5BqgWqE8Ox9EaAm6Ty',0,1);
