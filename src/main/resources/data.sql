...
VALUES (1,'M','ADMIN','Admin',null,'admin@escalade.org','ADMIN','$2a$10$IRKMI.Gzq83HyHvat5y0feUuxwYl5Eu22Rmr56q1WyVkiqv2vboSO', 1,1,1,1);
INSERT INTO utilisateur (id, civilite, nom, prenom, telephone, mail, login, mot_de_passe, enabled, token_expired, est_membre, adresse_id)
VALUES (2,'M','DUPONT','Martin','0324593874','martin.dupont@gmail.com','dupont','$2a$10$TpRLNPP8Q1XJqONRvS4QI.ea2f5.jsB/.U4ZnL3iSyFiGZ6pBPHfe', 1,1,0,1);
INSERT INTO utilisateur (id, civilite, nom, prenom, telephone, mail, login, mot_de_passe, enabled, token_expired, est_membre, adresse_id)
VALUES (3,'M','TINTIN','Paul','0654654874','paul.depres@hotmail.com','tintin','$2a$10$b/DpB2NSMWMokB.ZOP/D4ehRFqXRSx3fKib5BqgWqE8Ox9EaAm6Ty', 1, 1,0,1);
-- insertion roles
INSERT INTO role(id,name)
VALUES (1,'ROLE_ADMIN');
INSERT INTO role(id,name)
VALUES (2,'ROLE_USER');
INSERT INTO utilisateur_roles VALUES (1,1);
INSERT INTO utilisateur_roles VALUES (2,2);
INSERT INTO utilisateur_roles VALUES (3,2);
-- insertion topo
